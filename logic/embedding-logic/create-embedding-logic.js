...
class CreateEmbeddingLogic {
    ...
    async createEmbeddings(reqCtx) {
       ...
       // const base64EncodedVideo = buffer.toString('base64');
        ...
        console.log('responseAnalysis', responseAnalysis.candidates[0].content.parts);
    ...
    async generateAnalysisPrompt(objective){
        ...
        these experience you will have to evaluate the Ugc add video attached and provide your feedback on it, in form of Analysis (In analysis part 
        you had to provide two things, first is positive observation you had about the product and second is the negative observation), and second
